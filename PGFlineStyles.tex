...
\pgfplotsset{Lcyan/.style={mark = none, draw = cyan, line width = 1, line cap = round, line join = round}}
...
\pgfplotsset{LMblack/.style={mark = *, draw = black, mark options={scale=1, fill=black!10, line width = .5, line join = round}, line width = .5, line cap = round, line join = round}}
